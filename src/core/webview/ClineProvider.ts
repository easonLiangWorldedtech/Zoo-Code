	...
	*/
	...
	> {
		...
		return {
			...
			perWriteCheckpoints: mergedStateValues.perWriteCheckpoints ?? DEFAULT_PER_WRITE_CHECKPOINTS,
			changeCardDetail: mergedStateValues.changeCardDetail ?? DEFAULT_CHANGE_CARD_DETAIL,
