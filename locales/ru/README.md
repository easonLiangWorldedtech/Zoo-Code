...
## Что нового в v3.82.0

- 🔑 **Используйте свой API-ключ Zoo Gateway где угодно** — подключите его к любому клиенту или workflow, совместимому с OpenAI: https://zoocode.dev/models
- 🎁 **Бесплатный доступ к модели в течение ограниченного времени** — получите бесплатный доступ к MiniMax-M3 через Zoo Gateway.
- ✨ **Совершенно новые модели** — GPT-6 Astra и Claude Fable 5.1 уже доступны.
