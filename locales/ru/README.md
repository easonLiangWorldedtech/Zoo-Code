...
## Что нового в v3.80.0

- **Более безопасный доступ к файлам** — используйте отдельные списки разрешённых путей для чтения и записи, чтобы контролировать, к каким путям может обращаться Zoo Code.
- **Больше моделей на выбор** — GLM 5.3 теперь доступна через Z.ai, а Gemini 3.5 Flash Lite и Gemini 3.1 Flash Lite добавлены в провайдер Gemini.
- **Более надёжные повседневные процессы** — улучшены восстановление и история задач, streaming и использование инструментов провайдерами, импорт настроек и читаемость в разных темах IDE.
