...
- **より安全なファイルアクセス** — 読み取り用と書き込み用の許可リストを分けて、Zoo Code がアクセスできるパスを制御できます。
- **モデルの選択肢がさらに充実** — GLM 5.3 が Z.ai で利用可能になり、Gemini プロバイダーに Gemini 3.5 Flash Lite と Gemini 3.1 Flash Lite が追加されました。
- **日常のワークフローをより確実に** — タスクの復元と履歴、プロバイダーのストリーミングとツール使用、設定のインポート、IDE テーマ全体での読みやすさを改善しました。
