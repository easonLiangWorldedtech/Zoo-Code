...
- 🔑 **随处使用你的 Zoo Gateway API 密钥** — 可将其用于任何兼容 OpenAI 的客户端或工作流：https://zoocode.dev/models
- 🎁 **限时免费使用模型** — 通过 Zoo Gateway 免费使用 MiniMax-M3。
- ✨ **全新模型** — GPT-6 Astra 和 Claude Fable 5.1 现已上线。
