...
- **更安全的文件访问** — 使用独立的读取和写入允许列表，控制 Zoo Code 可以访问的路径。
- **更多模型选择** — GLM 5.3 现已通过 Z.ai 提供，Gemini provider 也新增了 Gemini 3.5 Flash Lite 和 Gemini 3.1 Flash Lite。
- **更可靠的日常工作流** — 改进增强了任务恢复与历史记录、provider 流式传输与工具使用、设置导入，以及不同 IDE 主题下的可读性。
